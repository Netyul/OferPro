...
if (isset($_GET['solicitacao'])) {
  $colname_socilitacoesVender = $_GET['solicitacao'];
}
...
$updateSQL = sprintf("UPDATE solicitacoes SET vendido=%s WHERE id=%s",
  ...
  $updateGoTo = "solicitacao.php?id=".$row_socilitacoesVender['id_lojista']."&action=vendido";
