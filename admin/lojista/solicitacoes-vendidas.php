...
<main>
    <div class="container">
        <div class="area principal">
			...
			?>
            <h2> <span class="glyphicon glyphicon-bookmark icon-destaque"></span> Solicitações Vendidas</h2>
            <?php ?>
            <!-- InstanceEndEditable -->
            </div>
            <div class="row">
            <!-- InstanceBeginEditable name="conteudo" -->
             <div class="col-md-12" style="padding-bottom:5px;" align="right">
            	<a href="ofertas.php?id=<?php echo $row_solicitacoes['id_lojista']; ?>" class="btn btn-Oferapp">Ofertas</a>
              	...
              	<div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                            <td colspan="3">Nenhuma Venda Efetuada</td>
                            </tr>
                            <?php } else{do { ?>
                            <tr>
                                <td>
