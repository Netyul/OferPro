        ...
        <div class="area principal">
            ...
            <!-- InstanceBeginEditable name="conteudo" -->
              ...
              <div class="panel panel-default">
                	<div class="panel-heading">Tablóides Cadatrados</div>
                    <div class="panel-body">
               
                      
                      	  <?php if($totalRows_tabloide == 0){?>
                        
                          	<p align="left">Não a Tablóides cadastradas para esse lojista</p>
              ...
              <div class="col-md-8">
              	<div class="panel panel-default">
                    <div class="panel-heading">Cadastrar Tablóides</div>
                    <div class="panel-body">
                      <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" class="form-horizontal">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <input type="file" name="img" value="<?php echo htmlentities($row_editartabloide['img'], ENT_COMPAT, 'utf-8'); ?>" class="form-control"  required>
                            </div>
                        </div>
                          <div class="form-group">
