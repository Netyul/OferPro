...
if(isset($_POST['salvar'])){
	...
	if($termos){
		...
		elseif($senhac != $comSenha){
			...
			$cadastro_query = "INSERT INTO usuario(nome, email, datanascimento, senha, celular, sexo) VALUES('".$nome."', '".$email."', '".$dataNascimento."', '".$senhac."', '".$celular."', '".$sexo."')";
                ...
                <form class="form-horizontal" role="form" method="post" action="">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-4">
                            <input type="date" class="form-control" id="data" name="data" placeholder="" value="<?php if(isset($msgc)){ echo $_POST['data'];}?>" v>
                            </div>
         				</div>
                        <div class="form-group">
